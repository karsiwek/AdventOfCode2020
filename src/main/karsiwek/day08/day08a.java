...
public class day08a {
    ...
    static List<Instruction> parseInput(final String input) {
        return Arrays.asList(input.split("\n"))
                .stream()
                .map(el -> new Instruction(el.split(" ")[0], Integer.parseInt(el.split(" ")[1])))
                .collect(Collectors.toList());
    }

    static int findInfinityLoop(final List<Instruction> code, int acc) {
    ...
    public static void main(final String[] args) {
        System.out.println(findInfinityLoop(parseInput(input), 0));
    }
